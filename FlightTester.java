...
public class FlightTester {
	...
	public static void main(String[] args) throws Exception {
		...
		Flight allFlights[] = new Flight[5];
			...
			// prompts the user to enter the data file and read it in
		...
		output = "";
		   	...
		   	// read in from the data file the airline, origin, destination, and the flight
		...
		while (fromFile.hasNext()) // need to change condition
		{
			...
			flightNumber = Integer.parseInt(flightNumberText);
			   	...
			   	// instantiate an object from the Flight class and pass to the constructor the arguments read
				// from the data file
