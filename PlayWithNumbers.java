...
public class PlayWithNumbers {
    ...
    enum IceCream {cookies_n_cream, chocolate, mint_chocolate_chip, vanilla, cookie_dough, chocolate_chip_cookie_dough};
	...
	public static void main(String[] args) {
	      ...
	      String valueText;
	      String name = "Eric Escalante"; // replace with your name
	...
	static void determinePay(int answer, double earnings)
	{
		int type;
		 ...
		 if (answer == YES)
		 {
			 ...
			 switch (type)
			 {
			 case 0: typeIceCream = IceCream.cookies_n_cream; break;
			 case 1: typeIceCream = IceCream.chocolate; break;
			 case 2: typeIceCream = IceCream.mint_chocolate_chip; break;
			 case 3: typeIceCream = IceCream.vanilla; break;
			 case 4: typeIceCream = IceCream.cookie_dough; break;
			 case 5: typeIceCream = IceCream.chocolate_chip_cookie_dough; break;
